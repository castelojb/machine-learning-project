...
from ml_core.classification.logistic_regression.logistic_functions import sigmoid
from ml_core.regression.base_class import LinearModel, LinearAlgoritm
...
class LogisticBinaryModel(LinearModel):
	...
	def first_model(lenght: int, fill_value: float,
					logistic_function: Callable[[np.ndarray], np.ndarray] = sigmoid) -> 'LogisticBinaryModel':
